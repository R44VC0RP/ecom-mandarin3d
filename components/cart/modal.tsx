              ...
              {!cart || cart.lines.length === 0 ? (
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                                  ...
                                  <div className="flex flex-1 flex-col text-base">
                                    ...
                                    {item.merchandise.selectedOptions ? (
                                      <p className="text-sm text-neutral-500 dark:text-neutral-400">
                                        {item.merchandise.selectedOptions.map(option => option.name).join(', ')}
                                      </p>
                                    ) : null}
                                  </div>
                                </Link>
                  ...
                  <form action={async (formData: FormData): Promise<void> => {
                    ...
                    if (result !== 'No checkout URL available') {
                      closeCart();
                    }
                  }}>
                    <CheckoutButton />
...
function CheckoutButton() {
  ...
  return (
    <button
      className="block w-full rounded-full bg-[--m3d-primary-border] p-3 text-center text-sm font-medium text-white opacity-90 hover:opacity-100"
      type="submit"
      disabled={pending}
    >
